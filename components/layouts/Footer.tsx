    ...
    <footer className="border-t border-divider bg-neutral-surface">
      <div className="mx-auto max-w-7xl px-6 py-8 lg:px-8">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {/* Brand Section */}
          <div>
            <h3 className="text-lg font-semibold text-primary mb-3">Colin Rodrigues</h3>
        ...
        {/* Bottom Section */}
        <div className="mt-8 border-t border-divider pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-text-secondary">
